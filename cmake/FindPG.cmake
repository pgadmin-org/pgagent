...
EXECUTE_PROCESS(COMMAND ${PG_CONFIG_PATH} --version OUTPUT_VARIABLE PG_VERSION_STRING RESULT_VARIABLE _retval)
...
IF(NOT _retval)
    ...
    ELSE(WIN32 AND NOT CYGWIN AND NOT MSYS)
        ...
        EXECUTE_PROCESS(COMMAND ${PG_CONFIG_PATH} --includedir OUTPUT_VARIABLE PG_INCLUDE_DIRS)
        EXECUTE_PROCESS(COMMAND ${PG_CONFIG_PATH} --libdir OUTPUT_VARIABLE PG_LIBRARY_DIRS)
        EXECUTE_PROCESS(COMMAND ${PG_CONFIG_PATH} --pkglibdir OUTPUT_VARIABLE PG_PKG_LIBRARY_DIRS)
        EXECUTE_PROCESS(COMMAND ${PG_CONFIG_PATH} --sharedir OUTPUT_VARIABLE PG_SHARE_DIR)

        IF(_static)
            LIST(APPEND PG_LIBRARIES ${PG_LIBRARY_DIRS}/libpq.a)

            # Check for SSL and Kerberos
            EXECUTE_PROCESS(COMMAND "nm" ${PG_LIBRARY_DIRS}/libpq.a  OUTPUT_VARIABLE _op)
